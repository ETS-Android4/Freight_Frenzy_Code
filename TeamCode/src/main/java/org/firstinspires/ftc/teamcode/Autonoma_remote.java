...
//        turnWithGyro(80,-0.75);
//        moveToPosition(-60, 0.8);
//        car_navigation(1);
//        strafeToPosition(-50,0.8);
//        turnWithGyro(10,-0.75);
////        moveToPosition(275,1);
//
//        telemetry.addData("ready for arm extension","top");
//        telemetry.update();
        ...
        if (tfod != null) {
            ...
            if (updatedRecognitions != null && !gotEm) {
                ...
                if (updatedRecognitions.size() == 1) {
                    ...
                    if (recognition.getLabel().equals(LABEL_THIRD_ELEMENT))
                        caz_dreapta();
                    ...
                    requestOpModeStop();
                    telemetry.addData("no object detected", "stopping autonomous");
                    telemetry.update();
                }
                    /*
